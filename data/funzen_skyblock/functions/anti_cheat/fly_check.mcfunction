execute as @a[gamemode=!creative,gamemode=!spectator,nbt=!{FallFlying:1b}] at @s if predicate funzen_skyblock:fly_air_check run scoreboard players add @s fly_count 2
